...
class TestEntsoeClient {
    ...
    void testInvalidDate() {
        ...
        Assertions.assertEquals("https://web-api.tp.entsoe.eu/api?securityToken=" + TOKEN + "&documentType=A44&in_Domain=10Y1001A1001A82H&out_Domain=10Y1001A1001A82H&periodStart=190001010000&periodEnd=190001012300", requestURL);
    ...
    void testGetRaw() {
        ...
        String requestURL = entsoeClient.getRequestURL(entsoeDate);
        Assertions.assertEquals("https://web-api.tp.entsoe.eu/api?securityToken=" + TOKEN + "&documentType=A44&in_Domain=10Y1001A1001A82H&out_Domain=10Y1001A1001A82H&periodStart=202301010000&periodEnd=202301012300", requestURL);
        String spotpriceDataRaw = entsoeClient.getSpotpriceDataRaw(entsoeDate);
        System.out.println(spotpriceDataRaw);
        Assertions.assertNotNull(spotpriceDataRaw);
    ...
    void testMisc() {
        ...
        EntsoeDate entsoeDate = EntsoeDate.fromENTSOEDateString("202308031200");
        String prettyString = entsoeDate.toPrettyUTCString();
        Assertions.assertEquals("2023-08-03 12:00", prettyString);
    }
    ...
    void testSpecificDate() {
        ...
        EntsoeDate entsoeDate = EntsoeDate.fromENTSOEDateString("202310300000");
        EntsoeClient entsoeClient = new EntsoeClient(TOKEN);
        var spotpriceDataRaw = entsoeClient.getSpotpriceDataRaw(entsoeDate);
        System.out.println(spotpriceDataRaw);
        var timeSeries = entsoeClient.getTimeSeries(entsoeDate, EntsoeResolution.PT60M);
    ...
    void testSpecificDate2() {
        ...
        EntsoeDate entsoeDate2 = EntsoeDate.fromENTSOEDateString("202310300000");
        EntsoeClient entsoeClient = new EntsoeClient(TOKEN);
        var timeSeries1 = entsoeClient.getSpotpriceDataRaw(entsoeDate1);
        System.out.println(timeSeries1);
        var timeSeries2 = entsoeClient.getSpotpriceDataRaw(entsoeDate2);
        System.out.println(timeSeries2);
        Assertions.assertNotEquals(timeSeries1, timeSeries2);
    }

    @Test
    void testSpecificDate3() {
        if (TOKEN == null || TOKEN.isBlank()) {
            return;
        }
        EntsoeDate entsoeDate1 = EntsoeDate.fromENTSOEDateString("202310290000");
        EntsoeDate entsoeDate2 = EntsoeDate.fromENTSOEDateString("202310300000");
        EntsoeClient entsoeClient = new EntsoeClient(TOKEN);
        var timeSeries1 = entsoeClient.getTimeSeries(entsoeDate1, EntsoeResolution.PT60M);
        System.out.println(timeSeries1);
        var timeSeries2 = entsoeClient.getTimeSeries(entsoeDate2, EntsoeResolution.PT60M);
        System.out.println(timeSeries2);
        Assertions.assertNotEquals(timeSeries1, timeSeries2);
    }
